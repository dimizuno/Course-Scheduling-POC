...
//                "BKV", "KI", "MOC", "PAP", "ROB", "SWD"); // 7, 8, 9, 10, 11, 12
        ...
        // Constraints: Alldiff (kind of :D)
        IntVar modsPerSemVar = model.intVar("modsPerSemVar", modsPerSem);
//        for (int i = 0; i < maxSems; i++) {
//            IntVar row = model.intVar("intVar_" + i, i);
//            model.count(row, modulVars, modsPerSemVar).post();
//        }
